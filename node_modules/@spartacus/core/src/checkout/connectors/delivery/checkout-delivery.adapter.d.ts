...
export declare abstract class CheckoutDeliveryAdapter {
    /**
     ...
     * @param addressId
     */
    abstract setAddress(userId: string, cartId: string, addressId: string): Observable<any>;
    /**
     ...
     */
    abstract setMode(userId: string, cartId: string, deliveryModeId: string): Observable<any>;
    /**
