 ...
 */
export declare function processesLoaderReducer<T>(entityType: string, reducer?: (state: T, action: Action) => T): (state: ProcessesLoaderState<T>, action: ProcessesLoaderAction) => ProcessesLoaderState<T>;
