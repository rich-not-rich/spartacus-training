...
export declare const getAnonymousConsentByTemplateCode: (templateCode: string) => MemoizedSelector<StateWithAnonymousConsents, AnonymousConsent, import("@ngrx/store").DefaultProjectorFn<AnonymousConsent>>;
